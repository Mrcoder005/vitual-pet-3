var dogImg, happyDogImg, dog, database, foodS, foodStock, canvas, lastFed,  foodObj, feed, addFood, food1, foodCount, input, milk, milkImg, gameState, readState, bedRoomImg, washRoomImg, gardenImg, sadDogImg, currentTime;
hour = hour();
function preload() {
